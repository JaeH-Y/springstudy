...
public class BoardDTO {
	...
	// Long(객체 타입 변수)를 사용하는 것이 훨씬 안전하고 좋은 습관(long을 쓰면 0으로 초기화 -> 이게 0번 게시물인지, 번호가 없는지 모호함) 
	private Long bno;
...
//		// 기존 생성자 방식: 순서에 맞춰 파라미터를 전달해야하고, 어떤 값이 어떤 필드인지 한눈에 알기 어렵다.
...
//		
//		// @Builder
//		// 롬복에서 제공하는 어노테이션으로 필더 패턴(Builder Pattern)을 자동으로 구현해주는 역할
//		// 장점: 생성자 파라미터 순서 기억 불필요, 필트 선택적 생성 가능
